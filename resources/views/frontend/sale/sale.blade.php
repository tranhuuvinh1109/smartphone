					...
					<div class="col-md-12">
						<div class="container-inner">
							<ul>
								...
								<li class="category3"><span>Sale Product</span></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="topbar-left">
							...
							<aside class="sidebar-content">
                                ...
                                @foreach($categorys as $item)
									<li><a href="javascript:">{{$item->category_name}}</a></li>
                                @endforeach
								</ul>
							</aside>
							<aside class="sidebar-content">
								...
								<ul>
									<li><a href="javascript:">Not available</a><span> (1)</span></li>
									<li><a href="javascript:">In stock</a><span> (2)</span></li>
								</ul>
							</aside>
							...
							<aside class="sidebar-content">
								...
								<ul>
									<li><a href="javascript:">Colorful Dress</a><span> (1)</span></li>
									<li><a href="javascript:">Maxi Dress</a><span> (2)</span></li>
									<li><a href="javascript:">Midi Dress</a><span> (2)</span></li>
									<li><a href="javascript:">Short Dress</a><span> (2)</span></li>
									<li><a href="javascript:">Short Sleeve</a><span> (2)</span></li>
								</ul>
							</aside>		
							<aside class="widge-topbar">
								<div class="bar-title">
								...
								<div class="exp-tags">
									<div class="tags">
										...
										<a href="javascript:">electronic</a>
										<a href="javascript:">destop</a>
										<a href="javascript:">tablet</a>
										<a href="javascript:">accessories</a>
										<a href="javascript:">camcorder</a>
															...
															<div class="product-img">
																...
																<div class="action-zoom">
																	<div class="add-to-cart">
																		<a href="javascript:" title="Quick View"><i class="fa fa-search-plus"></i></a>
																	</div>
																</div>
																<div class="actions">
																	<div class="action-buttons">
																		<div class="add-to-links">
																			<div class="add-to-wishlist">
																				<a title="Add to Wishlist"><i class="fa fa-heart"></i></a>
																			</div>
																		...
																		<div class="quickviewbtn">
																			<a href="javascript:" title="Add to Compare"><i class="fa fa-retweet"></i></a>
																		</div>
																	</div>
																</div>
																<div class="price-box">
			...
			<div class="container">
				<div class="row">
					<div class="brand-carousel">
						<div class="brand-item"><a href="javascript:"><img src="img/brand/bg1-brand.jpg" alt="" /></a></div>
						<div class="brand-item"><a href="javascript:"><img src="img/brand/bg2-brand.jpg" alt="" /></a></div>
						<div class="brand-item"><a href="javascript:"><img src="img/brand/bg3-brand.jpg" alt="" /></a></div>
						<div class="brand-item"><a href="javascript:"><img src="img/brand/bg4-brand.jpg" alt="" /></a></div>
						<div class="brand-item"><a href="javascript:"><img src="img/brand/bg5-brand.jpg" alt="" /></a></div>
						<div class="brand-item"><a href="javascript:"><img src="img/brand/bg2-brand.jpg" alt="" /></a></div>
						<div class="brand-item"><a href="javascript:"><img src="img/brand/bg3-brand.jpg" alt="" /></a></div>
						<div class="brand-item"><a href="javascript:"><img src="img/brand/bg4-brand.jpg" alt="" /></a></div>
					</div>
